...
# Gestiona el modelo ValorIntermedioXActividad.
class ValorIntermedioXActividad < ActiveRecord::Base
  #untranslate_all
  belongs_to :actividad_x_etapa
  belongs_to :usuario
  validates_presence_of :actividad_x_etapa_id, :message => _("Actividad") + " " + _("no puede estar vacía.")
