...
# Clases del modelo que gestiona la entidad PresupuestoIngresoDetallado, es decir el detalle temporal de cada linea de presupuesto
class PresupuestoIngresoDetallado< ActiveRecord::Base

  before_destroy :verifica_etapa

  belongs_to :presupuesto_ingreso
