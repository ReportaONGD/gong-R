module Swagger::ConveniosSchema
  ...
  included do
   ...
   swagger_schema :Resultado do
    ...
    swagger_schema :ConveniosDatosGenerales do
      property :identificador_financiador do
        key :type, :string
      end
      property :nombre do
      ...
      property :sector_principal do
        key :type, :string
      end
      property :sectores_secundarios do
        key :type, :string
      end
      property :objetivo_estrategico_principal do
        key :type, :string
      end
      property :pais do
        key :type, :string
      ...
      property :otras_entidades do
        key :type, :string
      end
      property :poblacion_beneficiaria do
        key :type, :string
      end
      property :poblacion_beneficiaria do
        key :type, :string
      ...
      property :aportacion_financiador_recibida do
        key :type, :string
      end
      property :aportacion_financiador_ejecutada do
        key :type, :string
      end
      property :presupuestado_total_pac do
        key :type, :string
      end
      property :ejecutado_total_pac  do
        key :type, :string
      end
      property :presupuestado_financiador_pac do
        key :type, :string
      end
      property :ejecutado_financiador_pac do
        key :type, :string
      end
